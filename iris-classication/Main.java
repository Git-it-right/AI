...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        double[][] zValues  = {new double[4], new double[5], new double[3]};
        //aValues will store the activated values for all neurons
        double[][] aValues  = {new double[4], new double[5], new double[3]};
        ...
        double[][][] deltaWeightValues  = {new double[4][5],new double[5][3]};
        //errorValues will store the error values for each node in the hidden and output layer
        double[][] errorValues = {new double[4], new double[5], new double[3]};
        //stores the delta in bias values per layer
        double[][] deltaBiasValues = {new double[5], new double[3]};
        //init zValues to 0
        for(int i = 0; i< 3; i++){
        ...
        double[][] biasArr = {new double[5], new double[3]};
        //weightArr is a 3d array that holds the weight between input->hidden and hidden -> output
        double[][][] weightArr = {new double[4][5],new double[5][3]};
